...
// Generated by `MbedtlsBuilder::compile` next to the merged `mbedtls_config.h`:
// declares the `mbedtls_*_soft_*` software fallbacks of the whole-module `_ALT`
// hooks (context structs and functions). Must come last - it re-includes the
// hooked modules' headers under renamed symbols.
#include "mbedtls_rs_sys_soft_fallback.h"
